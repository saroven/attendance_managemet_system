      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="nav treeview" id="user">
         ...
         <li class="treeview" id="attendance">
          ...
          <ul class="treeview-menu">
            <li class="treeview" id="trainer">
              <a href="#"><i class="fa fa-user"></i> Trainer
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li id="pending"><a href="<?php echo $base_url; ?>/management/attendance/trainer-attendance/pending.php"><i class="fa fa-circle-o"></i> Pending</a></li>
                <li id="manage"><a href="<?php echo $base_url; ?>/management/attendance/trainer-attendance/manage.php"><i class="fa fa-square"></i> manage</a></li>
              </ul>
            </li>
            ...
            <li class="treeview" id="student">
              ...
              <ul class="treeview-menu">
                <li id="student-attendance-pending"><a href="<?php echo $base_url; ?>/management/attendance/student-attendance/pending.php"><i class="fa fa-circle-o"></i> Pending</a></li>
                <li id="manage"><a href="<?php echo $base_url; ?>/management/attendance/student-attendance/manage.php"><i class="fa fa-square"></i> manage</a></li>
              </ul>
            </li>
          </ul>

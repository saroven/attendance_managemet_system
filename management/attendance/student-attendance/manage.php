<?php 
	...
	if (isset($_GET)) {
		$attendances = AllstudentAttendances($conn, $_GET);
	}else{
		$attendances = AllstudentAttendances($conn);
	}
?>
 ...
 <!-- DataTables -->
                ...
                <tbody>
                  <?php if(mysqli_num_rows($attendances) > 0) { ?>
                        ...
                        <tr>
                          ...
                          <td><?php if($attendace['approved'] == 1){ echo "Approved";}elseif($attendace['approved'] == 0){echo "Pending";}else{echo "Rejected";} ?></td>
                          <td style="text-align: center;">
                            <a href='edit.php?id=<?php echo $attendace["id"]; ?>'><i class="fa fa-pencil"></i></a>
                          </td>
                          <td style="text-align: center;">
                          	<a href='delete.php?id=<?php echo $attendace["id"]; ?>'><i class="fa fa-close"></i></a>
                          </td>
                        </tr>
                        <?php } ?>
  ...
  <script type="text/javascript">
    $(function() {
        nav_highlight("attendance", "student", "student-attendance-pending");
    });

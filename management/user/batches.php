<?php
  ...
  if(isset($_POST['user_id'])){
    ...
    // for deleting existing checkbox data
                  ...
                  <tbody>
                    ...
                    <?php if(mysqli_num_rows($batches) > 0){ ?>
                      ...
                      <?php while($batch = mysqli_fetch_array($batches)) { ?>
                        <tr>
                          <td>
                            <input type="checkbox" id="batch-check-<?php echo $batch['id']; ?>" name="batch_ids[]" value="<?php echo $batch['id']; ?>" <?php if(in_array($batch['id'], $all_selected_batches)){ echo "checked"; } ?>>
                          </td>
